...
Before the number of monsters is set, you can gauge whether your intended encounter is deadly or not by using the "[[Lazy Dungeon Master CR Benchmark]]" section of this document.

...
First, build a quest-giving NPC by rolling for [[Patrons and NPCs | behavior and ancestry]] in the "[[Core Adventure Generators]]" section of this document. Choose a [[Names | name]] and any other details from the "[[NPC Generator]]" section.

Next, roll on the [[Quests]] in "[[Core Adventure Generators]]". Determine the location by rolling on the [[Condition, Description, and Origin | Condition, Description, Origin]], and [[Locations, Monuments, and Items | Location]] table.
...
Roll for a random monster on the Monster table in the "[[Random Dungeon Monster]]" section, selecting a dungeon level equal to your character level.
...
For consumable and permanent items, roll on the tables in the "[[Treasure Generator]]" section or a random treasure table of your choice. You can replace any consumable magic item with a _potion of healing_. You can replace any permanent magic item with a _+1 weapon_ of your choice.